...
type Config struct {
	...
	// ProviderQuota configures recurring spend-budget windows by provider name.
	ProviderQuota map[string]ProviderQuota `yaml:"provider-quota,omitempty" json:"provider-quota,omitempty"`
